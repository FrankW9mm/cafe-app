    ...
    <div id="about" className="flex flex-col">
      ...
      >
        ...
        >
          ...
          <h1 className=" text-white font-extrabold text-[28px]">Since 1932</h1>
        </div>
        <div className=" flex flex-col justify-between md:p-[30px] p-[10px] lg:items-center items-center gap-[30px]">
